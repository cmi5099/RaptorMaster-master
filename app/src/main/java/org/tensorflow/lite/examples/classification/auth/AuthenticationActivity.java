...
package org.tensorflow.lite.examples.classification.auth;
...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button purchaseButton = findViewById(R.id.getstarted_button);
    ...
    private void showConfirmation(byte[] encrypted) {
        ...
        if (encrypted != null) {
            ...
            Intent intent = new Intent(this, org.tensorflow.lite.examples.classification.ClassifierActivity.class);
